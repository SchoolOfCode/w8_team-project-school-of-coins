...
async function getDecks() {
  ...
  const response = await fetch(
    `https://deckofcardsapi.com/api/deck/new/shuffle/?deck_count=${DECKS_TO_FETCH}`
  );
...
async function startGame() {
  /*#################################################################
    ...
    #################################################################*/
  const SOCtable = document.querySelector("body");
  SOCtable.style.backgroundImage = "url('./images/SOCtable.png')";
  //   SOCtable.style.backgroundSize = "500px 600px";
  //   SOCtable.style.backgroundPosition = "-90px 0px";
