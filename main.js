// DOM Selectors #######################################################
const playerBalanceDisplay = document.querySelector(
...
const usernameAvatarContainerElem = document.querySelector(
...
resetBtn.addEventListener("click", function () {
  resetBoard(
    blackjackPlayers.player("Dealer"),
    blackjackPlayers.player(username)
  );
});
